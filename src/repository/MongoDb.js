...
class MongoDb extends BaseMongoDb implements IBaseDatabase {
  ...
  constructor(url: string, options?: Object = {}) {
    ...
    (async (): Promise<void> => this._init(url, options))();
  }
  ...
  insertOne = async (collectionName: string, entity: Object): Promise<*> =>
    this.__runForCollection(collectionName, async (collection: Object): Promise<
      *,
    > => {
  ...
  findOne = async (collectionName: string, query: Object): Promise<*> =>
    this.__runForCollection(collectionName, async (collection: Object): Promise<
      *,
    > => {
      const resultItem = await collection.findOne(this.__translateQuery(query));
